...
namespace LogicEngine.Physics2D
{
    ...
    public struct Rect
    {
        ...
        public Vector2f position
        {
            get
            {
                return new Vector2f(this.m_XMin, this.m_YMin);
            }
            set
            {
                this.m_XMin = value.x;
        ...
        public Vector2f center
        {
            get
            {
                return new Vector2f(this.x + this.m_Width / 2f, this.y + this.m_Height / 2f);
            }
            set
            {
        ...
        public Vector2f min
        {
            get
            {
                return new Vector2f(this.xMin, this.yMin);
            }
            set
            {
                this.xMin = value.x;
        ...
        public Vector2f max
        {
            get
            {
                return new Vector2f(this.xMax, this.yMax);
            }
            set
            {
                this.xMax = value.x;
        ...
        public Vector2f size
        {
            get
            {
                return new Vector2f(this.m_Width, this.m_Height);
            }
            set
            {
        ...
        ///   <para>True if the point lies within the specified rectangle.</para>
        /// </returns>
        public bool Contains(Vector3f point, bool allowInverse)
        {
            if (!allowInverse)
            {
        ...
        public static Vector2f NormalizedToPoint(Rect rectangle, Vector2f normalizedRectCoordinates)
        {
            return new Vector2f(UtilMath.Lerp(rectangle.x, rectangle.xMax, normalizedRectCoordinates.x), UtilMath.Lerp(rectangle.y, rectangle.yMax, normalizedRectCoordinates.y));
        }
        ...
        public static Vector2f PointToNormalized(Rect rectangle, Vector2f point)
        {
            return new Vector2f(UtilMath.InverseLerp(rectangle.x, rectangle.xMax, point.x), UtilMath.InverseLerp(rectangle.y, rectangle.yMax, point.y));
        }
